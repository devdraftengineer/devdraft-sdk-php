...
[**taxControllerFindAll**](TaxesApi.md#taxcontrollerfindall) | **GET** /api/v0/taxes | Get all taxes
...
$apiInstance = new DevDraftAISDK\Api\TaxesApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \DevDraftAISDK\Model\CreateTaxInput(); // \DevDraftAISDK\Model\CreateTaxInput | 

try {
    $apiInstance->taxControllerCreate($body);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\DevDraftAISDK\Model\CreateTaxInput**](../Model/CreateTaxInput.md)|  |
...
> taxControllerFindAll($skip, $take)
...
try {
    $apiInstance->taxControllerFindAll($skip, $take);
} catch (Exception $e) {
...
$body = new \DevDraftAISDK\Model\UpdateTaxInput(); // \DevDraftAISDK\Model\UpdateTaxInput | 
$id = "id_example"; // string | Tax ID

try {
    $apiInstance->taxControllerUpdate($body, $id);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\DevDraftAISDK\Model\UpdateTaxInput**](../Model/UpdateTaxInput.md)|  |
 **id** | **string**| Tax ID |
