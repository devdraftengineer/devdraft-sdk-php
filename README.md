...
```json
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/devdraftengineer/devdraft-sdk-php.git"
    }
  ],
  "require": {
    "devdraft/sdk": "*@dev"
...
```php
require_once('/path/to/devdraft/sdk/vendor/autoload.php');
```
...
$apiInstance = new DevdraftSDK\Api\APIHealthApi(
